...
class GetRoutesRequest extends $pb.GeneratedMessage {
  factory GetRoutesRequest({
    ...
    $core.Iterable<RouteTransportType>? transportTypes,
    $core.Iterable<RouteTheme>? themes,
  }) {
    final $result = create();
    ...
    if (transportTypes != null) {
      $result.transportTypes.addAll(transportTypes);
    }
    if (themes != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetRoutesRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'content'), createEmptyInstance: create)
    ...
    ..pc<RouteTransportType>(4, _omitFieldNames ? '' : 'transportTypes', $pb.PbFieldType.KE, valueOf: RouteTransportType.valueOf, enumValues: RouteTransportType.values, defaultEnumValue: RouteTransportType.WALKING)
    ..pc<RouteTheme>(5, _omitFieldNames ? '' : 'themes', $pb.PbFieldType.KE, valueOf: RouteTheme.valueOf, enumValues: RouteTheme.values, defaultEnumValue: RouteTheme.URBAN)
  ...
  @$pb.TagNumber(4)
  $pb.PbList<RouteTransportType> get transportTypes => $_getList(3);

  @$pb.TagNumber(5)
  $pb.PbList<RouteTheme> get themes => $_getList(4);
}
...
class Route extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Route', package: const $pb.PackageName(_omitMessageNames ? '' : 'content'), createEmptyInstance: create)
    ...
    ..e<RouteTransportType>(9, _omitFieldNames ? '' : 'transportType', $pb.PbFieldType.OE, defaultOrMaker: RouteTransportType.WALKING, valueOf: RouteTransportType.valueOf, enumValues: RouteTransportType.values)
    ..e<RouteTheme>(10, _omitFieldNames ? '' : 'theme', $pb.PbFieldType.OE, defaultOrMaker: RouteTheme.URBAN, valueOf: RouteTheme.valueOf, enumValues: RouteTheme.values)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(9)
  RouteTransportType get transportType => $_getN(8);
  @$pb.TagNumber(9)
  set transportType(RouteTransportType v) { $_setField(9, v); }
  @$pb.TagNumber(9)
  $core.bool hasTransportType() => $_has(8);
  @$pb.TagNumber(9)
  void clearTransportType() => $_clearField(9);

  @$pb.TagNumber(10)
  RouteTheme get theme => $_getN(9);
  @$pb.TagNumber(10)
  set theme(RouteTheme v) { $_setField(10, v); }
  @$pb.TagNumber(10)
...
class CreateRouteRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CreateRouteRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'content'), createEmptyInstance: create)
    ...
    ..e<RouteTransportType>(7, _omitFieldNames ? '' : 'transportType', $pb.PbFieldType.OE, defaultOrMaker: RouteTransportType.WALKING, valueOf: RouteTransportType.valueOf, enumValues: RouteTransportType.values)
    ..e<RouteTheme>(8, _omitFieldNames ? '' : 'theme', $pb.PbFieldType.OE, defaultOrMaker: RouteTheme.URBAN, valueOf: RouteTheme.valueOf, enumValues: RouteTheme.values)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(7)
  RouteTransportType get transportType => $_getN(6);
  @$pb.TagNumber(7)
  set transportType(RouteTransportType v) { $_setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasTransportType() => $_has(6);
  @$pb.TagNumber(7)
  void clearTransportType() => $_clearField(7);

  @$pb.TagNumber(8)
  RouteTheme get theme => $_getN(7);
  @$pb.TagNumber(8)
  set theme(RouteTheme v) { $_setField(8, v); }
  @$pb.TagNumber(8)
...
class GetRoutesFilterOptionsResponse extends $pb.GeneratedMessage {
  ...
  factory GetRoutesFilterOptionsResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory GetRoutesFilterOptionsResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetRoutesFilterOptionsResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'content'), createEmptyInstance: create)
    ..aOB(1, _omitFieldNames ? '' : 'empty')
    ..aOM<DistanceFilter>(2, _omitFieldNames ? '' : 'distanceBounds', subBuilder: DistanceFilter.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  GetRoutesFilterOptionsResponse clone() => GetRoutesFilterOptionsResponse()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  GetRoutesFilterOptionsResponse copyWith(void Function(GetRoutesFilterOptionsResponse) updates) => super.copyWith((message) => updates(message as GetRoutesFilterOptionsResponse)) as GetRoutesFilterOptionsResponse;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static GetRoutesFilterOptionsResponse create() => GetRoutesFilterOptionsResponse._();
  GetRoutesFilterOptionsResponse createEmptyInstance() => create();
  static $pb.PbList<GetRoutesFilterOptionsResponse> createRepeated() => $pb.PbList<GetRoutesFilterOptionsResponse>();
  @$core.pragma('dart2js:noInline')
  static GetRoutesFilterOptionsResponse getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<GetRoutesFilterOptionsResponse>(create);
  static GetRoutesFilterOptionsResponse? _defaultInstance;

  @$pb.TagNumber(1)
  $core.bool get empty => $_getBF(0);
  @$pb.TagNumber(1)
  set empty($core.bool v) { $_setBool(0, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set distanceBounds(DistanceFilter v) { $_setField(2, v); }
  @$pb.TagNumber(2)
